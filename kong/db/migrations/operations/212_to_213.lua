...
--------------------------------------------------------------------------------
-- HighGo operations for Workspace migration
--------------------------------------------------------------------------------
...
local highgo = {
  ...
  teardown = {
    -- These migrations were fixed since they were originally released,
    -- thus those that have updated already, need to re-run it.
    ws_update_composite_cache_key = operations_200_210.highgo.teardown.ws_update_composite_cache_key,
  },
...
highgo.teardown.ws_adjust_data = ws_adjust_data
