...
local CONF_PARSERS = {
  ...
  database = { enum = { "postgres", "cassandra", "off", "dm", "highgo", "mysql" }  },
  pg_port = { typ = "number" },
  ...
  dm_odbc_name = {typ = "string"},
  dm_username = {typ = "string"},
  dm_password = { typ = "string" },

  highgo_port = { typ = "number" },
  highgo_timeout = { typ = "number" },
  highgo_password = { typ = "string" },
  highgo_ssl = { typ = "boolean" },
  highgo_ssl_verify = { typ = "boolean" },
  highgo_max_concurrent_queries = { typ = "number" },
  highgo_semaphore_timeout = { typ = "number" },
  highgo_keepalive_timeout = { typ = "number" },
  highgo_pool_size = { typ = "number" },
  highgo_backlog = { typ = "number" },
  _debug_highgo_ttl_cleanup_interval = { typ = "number" },

  highgo_ro_port = { typ = "number" },
  highgo_ro_timeout = { typ = "number" },
  highgo_ro_password = { typ = "string" },
  highgo_ro_ssl = { typ = "boolean" },
  highgo_ro_ssl_verify = { typ = "boolean" },
  highgo_ro_max_concurrent_queries = { typ = "number" },
  highgo_ro_semaphore_timeout = { typ = "number" },
  highgo_ro_keepalive_timeout = { typ = "number" },
  highgo_ro_pool_size = { typ = "number" },
  highgo_ro_backlog = { typ = "number" },

  mysql_host = { typ = "string" },
  mysql_port = { typ = "number" },
  mysql_database = { typ = "string" },
  mysql_username = { typ = "string" },
