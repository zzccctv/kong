...
function _M.new(opts)
  ...
  do
    ...
    elseif opts.db.strategy == "dm" then
      db_strategy = require "kong.cluster_events.strategies.dm"

    elseif opts.db.strategy == "highgo" then
      db_strategy = require "kong.cluster_events.strategies.highgo"
