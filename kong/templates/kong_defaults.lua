...
highgo_host = 127.0.0.1
highgo_port = 5866
highgo_database = kong
highgo_schema = NONE
highgo_timeout = 5000
highgo_user = kong
highgo_password = NONE
highgo_ssl = off
highgo_ssl_verify = off
highgo_max_concurrent_queries = 0
highgo_semaphore_timeout = 60000
highgo_keepalive_timeout = NONE
highgo_pool_size = NONE
highgo_backlog = NONE
_debug_highgo_ttl_cleanup_interval = 300

highgo_ro_host = NONE
highgo_ro_port = NONE
highgo_ro_database = NONE
highgo_ro_schema = NONE
highgo_ro_timeout = NONE
highgo_ro_user = NONE
highgo_ro_password = NONE
highgo_ro_ssl = NONE
highgo_ro_ssl_verify = NONE
highgo_ro_max_concurrent_queries = NONE
highgo_ro_semaphore_timeout = NONE
highgo_ro_keepalive_timeout = NONE
highgo_ro_pool_size = NONE
highgo_ro_backlog = NONE
